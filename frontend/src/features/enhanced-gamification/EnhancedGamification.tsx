        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">{typeof playerProfile?.department === 'object' ? playerProfile?.department?.name : playerProfile?.department} • Rank #{playerProfile.rank}</p>
            </div>
          </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Level {entry.level} • {typeof entry?.department === 'object' ? entry?.department?.name : entry?.department}</p>
                </div>
              </div>
