        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">{(() => { const d = playerProfile?.department as any; if (!d) return ''; return typeof d === 'object' ? d.name : d; })()}  • Rank #{playerProfile.rank}</p>
            </div>
          </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Level {entry.level} • {(() => { const d = entry?.department as any; if (!d) return ''; return typeof d === 'object' ? d.name : d; })()}</p>
                </div>
              </div>
