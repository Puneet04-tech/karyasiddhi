                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      {typeof alert?.department === 'object' ? alert?.department?.name : (alert?.department || '')} • {alert.timestamp.toLocaleTimeString()} • {alert.citizenCount} citizens
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      {item.service} • {typeof item?.department === 'object' ? item?.department?.name : (item?.department || '')} • {item.location}
                    </p>
