...
SELECT 
  ...
  FLOOR(RANDOM() * 1000)::INT
FROM users
WHERE NOT EXISTS (SELECT 1 FROM enterprise_dna_governance WHERE user_id = users.id);
...
-- ============================================================================
-- TIDAL WAVE ANALYTICS - Auto-populate for all users
-- ============================================================================
...
-- ============================================================================
-- DEEPFAKE DETECTION - Auto-populate for all users
-- ============================================================================
...
-- ============================================================================
-- ALGORITHMIC JUSTICE - Auto-populate for all users
-- ============================================================================
...
-- ============================================================================
-- QUANTUM MANAGEMENT - Auto-populate for all users
-- ============================================================================
